...
# Title: B100 VHF NBFM transceiver
# Author: John Petrich, W7FU 12/15/15
# Description: B100 version VHF NBFM transceiver
# Generated: Sun Apr 17 12:54:38 2016
##################################################
...
class B100_NBFM_VHF_RX_TX_ver_10_5(grc_wxgui.top_block_gui):

    def __init__(self):
        grc_wxgui.top_block_gui.__init__(self, title="B100 VHF NBFM transceiver")
        ...
        self._tune_minus_10_chooser = forms.button(
        	...
        	label="-10 Tune",
        	choices=[0,-10e3, -20e3, -30e3, -40e3,0],
        	labels=[0, -10, -20, -30, -40,0],
        )
        ...
        self._chooser_fm_chooser = forms.radio_buttons(
        	...
        	label="Preset",
        	choices=[145.13e6,145.33e6, 145.88e6, 146.46e6, 146.49e6, 146.52e6,146.58e6, 146.64e6,146.74e6, 146.82e6, 146.86e6, 146.92e6, 146.96e6, 147.0e6,147.06e6, 147.08e6, 147.20e6, 147.22e6, 147.34e6, 441.825e6],
        	labels=[145.13,145.33, 145.88, 146.46, 146.49, 146.52, 146.58, 146.64, 146.74, 146.82, 146.860, 146.92, 146.96,  147.00, 147.06, 147.08,147.200, 147.220, '147.34 Wville', 441.825],
        	style=wx.RA_HORIZONTAL,
        )
        ...
        self.GridAdd(self.wxgui_fftsink2_0.win, 2, 0, 5, 16)
        ...
        self.uhd_usrp_source_0.set_center_freq((((((chooser_fm+tune_20)-tune_minus_20)+tune_10)+tune_minus_10)+rx_offset), 0)
        ...
        self.uhd_usrp_sink_1.set_samp_rate(256000)
        self.uhd_usrp_sink_1.set_center_freq((((((chooser_fm+offset)+tune_20)-tune_minus_20)+tune_10)+tune_minus_10), 0)
        self.uhd_usrp_sink_1.set_normalized_gain(.86, 0)
        ...
        self.high_pass_filter_0 = filter.fir_filter_fff(1, firdes.high_pass(
        	1, 32000, 400, 200, firdes.WIN_HAMMING, 6.76))
        self.blocks_null_source_0 = blocks.null_source(gr.sizeof_gr_complex*1)
        self.blocks_multiply_const_vxx_2 = blocks.multiply_const_vcc((.530, ))
        self.blocks_multiply_const_vxx_1 = blocks.multiply_const_vff((200, ))
        ...
        self.band_pass_filter_1 = filter.fir_filter_ccf(50, firdes.band_pass(
        	1, (samp_rate)/2, 10*0+200, 18500, 100, firdes.WIN_HAMMING, 6.76))
        self.audio_source_1 = audio.source(32000, "", True)
        self.audio_sink_0 = audio.sink(32000, "", True)
        self.analog_simple_squelch_cc_0 = analog.simple_squelch_cc(squelch, .1)
        self.analog_sig_source_x_0 = analog.sig_source_f(32000, analog.GR_COS_WAVE, tone, .081, 0)
        ...
        self.connect((self.band_pass_filter_1, 0), (self.analog_simple_squelch_cc_0, 0))    
    ...
    def set_tune_minus_20(self, tune_minus_20):
        ...
        self.uhd_usrp_sink_1.set_center_freq((((((self.chooser_fm+self.offset)+self.tune_20)-self.tune_minus_20)+self.tune_10)+self.tune_minus_10), 0)
        self.uhd_usrp_source_0.set_center_freq((((((self.chooser_fm+self.tune_20)-self.tune_minus_20)+self.tune_10)+self.tune_minus_10)+self.rx_offset), 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.band_pass_filter_1.set_taps(firdes.band_pass(1, (self.samp_rate)/2, 10*0+200, 18500, 100, firdes.WIN_HAMMING, 6.76))
...
def main(top_block_cls=B100_NBFM_VHF_RX_TX_ver_10_5, options=None):
