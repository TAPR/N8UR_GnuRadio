...
# Generated: Sat Apr 16 16:57:25 2016
##################################################
...
class noaa_demo(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.hardware_rate = hardware_rate = int(16e6)
        ...
        # Blocks
        ##################################################
        self._volume_range = Range(0, 1, 0.05, 0.15, 50)
        ...
        self.rtlsdr_source_0 = osmosdr.source( args="numchan=" + str(1) + " " + "hackrf" )
        ...
        self._ppm_range = Range(-20, 20, 0.5, 0, 50)
        self._ppm_win = RangeWidget(self._ppm_range, self.set_ppm, "ppm", "slider", float)
        self.top_grid_layout.addWidget(self._ppm_win, 0,2,1,1)
        ...
        self.connect((self.rtlsdr_source_0, 0), (self.blocks_multiply_const_vxx_0_7, 0))    
